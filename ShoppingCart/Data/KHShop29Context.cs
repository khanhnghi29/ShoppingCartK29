...
{
    public partial class KHShop29Context : DbContext
    {
        public KHShop29Context()
        {
        }

        public KHShop29Context(DbContextOptions<KHShop29Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("workstation id=KHShop29.mssql.somee.com;packet size=4096;user id=khanhnghi29_SQLLogin_1;pwd=vnc5f1mjwn;data source=KHShop29.mssql.somee.com;persist security info=False;initial catalog=KHShop29;TrustServerCertificate=True");
            }
        }*/
        ...
        public DbSet<ShoppingCart.ViewModels.CreateHangHoaViewModel>? CreateHangHoaViewModel { get; set; }
    }
}
